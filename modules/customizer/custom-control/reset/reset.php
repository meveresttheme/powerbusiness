...
* @since 1.0
*
* @package Power Business WordPress
*/

if ( class_exists( 'WP_Customize_Control' ) ) :

    class Power_Business_Customizer_Reset extends WP_Customize_Control {
        ...
        public function scripts(){
            ...
            wp_localize_script( 'power-business-customize-js', 'CUSTOMIZERRESET', array(
                'nonce'   => array(
                    'reset' => wp_create_nonce( 'customizer-reset' ),
                ),
                'confirm' => esc_html__( 'This action is not reversible! Are you sure to reset these settings?', 'power-business' )
            ));
        }
...
Power_Business_Customizer::add_custom_control( array(
    'type'     => 'reset',
    'class'    => 'Power_Business_Customizer_Reset',
    'sanitize' => false,
