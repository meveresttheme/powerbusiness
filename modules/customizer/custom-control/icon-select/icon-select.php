...
if ( class_exists( 'WP_Customize_Control' ) ) {
	class Power_Business_Customizer_Icon_Select_Control extends WP_Customize_Control {
		...
		public function enqueue() {
			...
			wp_register_style( 'font-awesome', 
				Power_Business_Helper::get_theme_uri( 'assets/css/vendor/font-awesome/css/font-awesome.css' ), 
				array(), '4.7.0' 
			);
...
Power_Business_Customizer::add_custom_control( array(
    'type'     => 'icon',
    'class'    => 'Power_Business_Customizer_Icon_Select_Control',
    'sanitize' =>  array( 'Power_Business_Customizer', 'sanitize_choice' )
));