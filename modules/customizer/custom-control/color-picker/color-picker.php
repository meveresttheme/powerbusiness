...
if ( class_exists( 'WP_Customize_Control' ) ) {
	...
	class Power_Business_Customizer_Color_Control extends WP_Customize_Control {
...
Power_Business_Customizer::add_custom_control( array(
    'type'     => 'color-picker',
    'class'    => 'Power_Business_Customizer_Color_Control',
    'sanitize' => array( 'Power_Business_Customizer', 'sanitize_rgba' ),
));