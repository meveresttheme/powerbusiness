 ...
 */
function power_business_responsive_device_css(){
	foreach( array( 'md' => 'desktop', 'sm' => 'tablet', 'xs' => 'mobile' ) as $size => $device ){

		Power_Business_Css::add_styles( array(
			#Typography
			array(
			...
			array(
				'selector' => '%s-inner-banner-wrapper',
				'props' => array(
...
add_action( 'init', 'power_business_responsive_device_css' );
